...
Before committing to the creation of secondary validation process involving the [redcap_rsvc](https://github.com/vanderbilt-redcap/redcap_rsvc) tests, it is recommended to [request a copy of the REDCap 21 CFR Part 11 Implementation Guide](https://redcap.link/part11ig) and consider including the official validation package in your documentation rather than duplicating that process.  If desired, it is complex but possible to create your own environment to run all automated tests yourself and fully reproduce Vanderbilt's validation process at your institution.  Vanderbilt is unable to assist in setting up such an environment for other institions, but provides this basic documentation as a starting point.
